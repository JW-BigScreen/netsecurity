//package com.uestc.netsecurity.config;
//
//import com.uestc.netsecurity.components.ScheduTask;
...
//     */
//    @Bean(name = "jobDetail")
//    public MethodInvokingJobDetailFactoryBean detailFactoryBean(ScheduTask task) {
//
...
//        tigger.setCronExpression("*/5 * * * * ?");// 初始时的cron表达式  ，每隔5秒执行一次
